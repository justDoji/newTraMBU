...
public class TimePointTest {
  ...
  public void fromDate() {
    ...
    assertThat(timePoint.toString(TimePoint.EXTENDED_DATE_TIME_PATTERN)).isEqualTo("16/12/2018 12:00:00:003");
  ...
  public void write_returnExpectedString() {
    TimePoint day2 = TimePoint.fromString("05/12/2018 00:00:00");
    String output = day2.toString(TimePoint.LEGACY_DATE_TIME_PATTERN);
