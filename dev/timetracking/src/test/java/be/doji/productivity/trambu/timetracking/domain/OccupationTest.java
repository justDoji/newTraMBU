...
public class OccupationTest {
  ...
  public void whenCreatingAnOccupation_compositeIsFilledIn() {
    Occupation testOccupation = Occupation.builder(repository, timeRule.service())
        ...
        .name(EXPECTED_NAME)
        .interval(PointInTime.parse("16/12/2018 12:00:00:000"), PointInTime.parse("16/12/2018 14:00:00:000"))
        .build();
  ...
  public void startedAt_usesProvidedTimestamp() {
    ...
    Assertions.assertThat(testOccupation.getIntervals()).hasSize(1);
