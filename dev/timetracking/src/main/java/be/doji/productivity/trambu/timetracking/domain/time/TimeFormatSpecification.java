...
class TimeFormatSpecification {
  ...
  private static TimeFormatSpecification BASIC_DATE = fromDate(TimeFormat.BASIC_DATE_REGEX,
      TimeFormat.BASIC_DATE_PATTERN);
  private static TimeFormatSpecification BASIC_DATETIME = fromDateTime(
      TimeFormat.BASIC_DATE_TIME_REGEX, TimeFormat.BASIC_DATE_TIME_PATTERN);
  static TimeFormatSpecification EXTENDED_DATE_TIME = fromDateTime(
      TimeFormat.EXTENDED_DATE_TIME_REGEX, TimeFormat.EXTENDED_DATE_TIME_PATTERN);
  private static TimeFormatSpecification LEGACY_DATETIME = fromDateTime(
      TimeFormat.LEGACY_DATE_TIME_REGEX, TimeFormat.LEGACY_DATE_TIME_PATTERN);
